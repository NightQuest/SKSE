...
//	DEFINE_MEMBER_FN(AddMessage, void, 0x004500C0, UIMessage * msg);	// old 1.1 implementation
	...
	DEFINE_MEMBER_FN(AddMessage, void, 0x00432240, StringCache::Ref * strData, UInt32 msgID, void * objData);

	static UIManager *	GetSingleton(void)
	{
		return *((UIManager **)0x012B1B34);
	}
};
...
public:
	...
	{
		return *((UIStringHolder **)0x012B1B30);
	}
};
