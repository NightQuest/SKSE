...
public:
	...
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x00C3F540);
	DEFINE_MEMBER_FN(Impl_GetParam, UInt32 *, 0x00C3F9C0, UInt32 idx, StringCache::Ref * nameOut, UInt32 * typeOut);
	DEFINE_MEMBER_FN(Impl_Invoke, UInt32, 0x00C3F720, UInt32 unk0, UInt32 unk1, UInt32 unk2, UInt32 unk3);
	DEFINE_MEMBER_FN(Impl_Fn10, StringCache::Ref *, 0x00C3F580);
	DEFINE_MEMBER_FN(Impl_Fn12, bool, 0x00C3F9D0, UInt32 idx, UInt32 out);
...
public:
	...
	DEFINE_MEMBER_FN(Impl_ctor, NativeFunction *, 0x00C3F670, const char * fnName, const char * className, UInt32 unk0, UInt32 numParams);
	DEFINE_MEMBER_FN(Impl_dtor, void, 0x00C3F540);
