...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(HasMember, bool, 0x00920130, void * obj, const char * name, bool isDisplayObj);
		DEFINE_MEMBER_FN(SetMember, bool, 0x00920200, void * obj, const char * name, GFxValue * value, bool isDisplayObj);
		DEFINE_MEMBER_FN(DeleteMember, bool, 0x009202C0, void * obj, const char * name, bool isDisplayObj);
		DEFINE_MEMBER_FN(GetMember, bool, 0x00922E50, void * obj, const char * name, GFxValue * value, bool isDisplayObj);
		DEFINE_MEMBER_FN(Invoke, bool, 0x009223C0, void * obj, GFxValue * result, const char * name, GFxValue * args, UInt32 numArgs, bool isDisplayObj);
		DEFINE_MEMBER_FN(AttachMovie, bool, 0x00922550, void * obj, GFxValue * value, const char * symbolName, const char * instanceName, SInt32 depth, void * initArgs);
		DEFINE_MEMBER_FN(PushBack, bool, 0x009203D0, void * obj, GFxValue * value);
		DEFINE_MEMBER_FN(SetText, bool, 0x00922890, void * obj, const wchar_t * text, bool html);
		//DEFINE_MEMBER_FN(PopBack, bool, 0x00000000, void * obj, GFxValue * value);
		DEFINE_MEMBER_FN(GetArraySize, UInt32, 0x00920360, void * obj);
		//DEFINE_MEMBER_FN(SetArraySize, bool, 0x00000000, void * obj, UInt32 size);
		DEFINE_MEMBER_FN(GetElement, bool, 0x00922FC0, void * obj, UInt32 index, GFxValue * value);
		...
		DEFINE_MEMBER_FN(AddManaged_Internal, void, 0x00921280, GFxValue * value, void * obj);
		DEFINE_MEMBER_FN(ReleaseManaged_Internal, void, 0x00921B40, GFxValue * value, void * obj);
	};
...
public:
	...
	DEFINE_MEMBER_FN(Destroy, GFxFunctionHandler *, 0x00858EC0, UInt32 flags);
};
