...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(HasMember, bool, 0x009096D0, void * obj, const char * name, bool isDisplayObj);
		DEFINE_MEMBER_FN(SetMember, bool, 0x009097A0, void * obj, const char * name, GFxValue * value, bool isDisplayObj);
		DEFINE_MEMBER_FN(GetMember, bool, 0x0090C480, void * obj, const char * name, GFxValue * value, bool isDisplayObj);
		DEFINE_MEMBER_FN(DeleteMember, bool, 0x00909860, void * obj, const char * name, bool isDisplayObj);
		DEFINE_MEMBER_FN(Invoke, bool, 0x0090B9F0, void * obj, GFxValue * result, const char * name, GFxValue * args, UInt32 numArgs, bool isDisplayObj);

		DEFINE_MEMBER_FN(ReleaseManaged_Internal, void, 0x0090B170, GFxValue * value, void * obj);
	};
...
public:
	...
	DEFINE_MEMBER_FN(Destroy, GFxFunctionHandler *, 0x0084A460, UInt32 flags);
};
