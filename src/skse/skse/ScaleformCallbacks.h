...
public:
	...
	public:
		...
		DEFINE_MEMBER_FN(HasMember, bool, 0x0091A3C0, void * obj, const char * name, bool isDisplayObj);
		DEFINE_MEMBER_FN(SetMember, bool, 0x0091A490, void * obj, const char * name, GFxValue * value, bool isDisplayObj);
		DEFINE_MEMBER_FN(GetMember, bool, 0x0091D0D0, void * obj, const char * name, GFxValue * value, bool isDisplayObj);
		DEFINE_MEMBER_FN(DeleteMember, bool, 0x0091A550, void * obj, const char * name, bool isDisplayObj);
		DEFINE_MEMBER_FN(Invoke, bool, 0x0091C640, void * obj, GFxValue * result, const char * name, GFxValue * args, UInt32 numArgs, bool isDisplayObj);

		DEFINE_MEMBER_FN(ReleaseManaged_Internal, void, 0x0091BDD0, GFxValue * value, void * obj);
	};
...
public:
	...
	DEFINE_MEMBER_FN(Destroy, GFxFunctionHandler *, 0x00853B00, UInt32 flags);
};
